...
KG_FILE = {
           ...
           'our':os.path.join(RAW_DATA_DIR,'our','train2id.txt')}
ENTITY2ID_FILE = {
                    'kegg':os.path.join(RAW_DATA_DIR,'kegg','entity2id.txt'),
                    'our':os.path.join(RAW_DATA_DIR,'our','entity2id.txt')}
EXAMPLE_FILE = {
               'kegg':os.path.join(RAW_DATA_DIR,'kegg','approved_example.txt'),
                'our':os.path.join(RAW_DATA_DIR,'our','approved_example.txt')}

SMILE_FILE = {
               'kegg': os.path.join(RAW_DATA_DIR,'kegg', 'smiles.npy'),
                'our': os.path.join(RAW_DATA_DIR,'our', 'smiles.npy')
                }

SEPARATOR = {'kegg':'\t', 'our':'\t' }
SEPARATOR_KG = {'kegg':' ', 'our':'\t' }
THRESHOLD = {'our':4,'kegg':4} 
NEIGHBOR_SIZE = {'kegg':16,'our':4}
...
RESULT_LOG={'kegg':'kegg_result.txt', 'our': 'result.txt'}
