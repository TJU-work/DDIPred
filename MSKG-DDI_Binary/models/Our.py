...
class Our(BaseModel):
    ...
    def build(self):
        ...
        score = Lambda(lambda x: K.sigmoid(K.sum(x[0] * x[1], axis=-1, keepdims=True))
        )([drug1_squeeze_embed_all, drug2_squeeze_embed_all])

        loss_config = BinaryCrossentropy()
    ...
    def score(self, x, y, threshold=0.5):
        ...
        return auc, acc, f1, aupr, precision, recall
